...
/**
 * This is the model class for table "jautoinvoice.IVA".
 *
 * The followings are the available columns in table 'jautoinvoice.IVA':
...
class IVA extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('idIVA, descricao, percentagem, activo', 'safe', 'on' => 'search'),
        );
    }
