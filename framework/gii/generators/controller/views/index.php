...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$form)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($form,'controller'); ?>
		<?php echo $form->textField($form,'controller',array('size'=>65)); ?>
		<div class="tooltip">
		...
		<?php echo $form->error($form,'controller'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($form,'actions'); ?>
		<?php echo $form->textField($form,'actions',array('size'=>65)); ?>
		<div class="tooltip">
			Action IDs are case-insensitive. Separate multiple action IDs with commas or spaces.
		</div>
		<?php echo $form->error($form,'actions'); ?>
	</div>
