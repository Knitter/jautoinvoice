...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$form)); ?>
	...
	<div class="row sticky">
		<?php echo $form->labelEx($form,'baseControllerClass'); ?>
		<?php echo $form->textField($form,'baseControllerClass',array('size'=>65)); ?>
		<div class="tooltip">
			This is the class that the new CRUD controller class will extend from.
			Please make sure the class exists and can be autoloaded.
		</div>
		<?php echo $form->error($form,'baseControllerClass'); ?>
	</div>
